class Carrito {
  ...
  //insertar al carrito de inicio
  insertarCarrito(producto) {
    const row = document.createElement("tr");
    row.innerHTML = `
            <td>
                <img class="carrito-producto"src="${producto.imagen}" width=90>
            </td>
  ...
  vaciarCarrito(e) {
    e.preventDefault();
    //mientras exista algun producto en nuesta lista
